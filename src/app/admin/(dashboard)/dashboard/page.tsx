                ...
                <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={stats.revenueWeek}>
                        ...
                        <Tooltip
                            ...
                            formatter={(value: any) => value ? `Rs ${Number(value).toLocaleString()}` : 'N/A'}
                        />
