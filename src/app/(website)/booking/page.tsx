...
export default function BookingPage() {
    ...
    return (
        <main className="bg-[var(--t-bg)] min-h-screen overflow-x-hidden">
            ...
            <button
                onClick={() => router.back()}
                className="fixed top-4 left-4 z-50 flex items-center gap-2 px-4 py-2 bg-[var(--t-bg-3)] border border-[var(--t-border-2)] text-[var(--t-text-2)] hover:text-[var(--t-text)] hover:border-[var(--t-accent)] transition-all shadow-sm rounded-full"
            >
